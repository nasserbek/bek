...
#define WIFI_SSID "HUAWEI-BEK"                                              //your WiFi SSID for which yout NodeMCU connects
#define WIFI_PASSWORD "ali09042010"                                     //Password of your wifi network 
...
void setup()
{
    ...
    if (Firebase.setInt(firebaseData,"AV/CH", 100))
    {
    ...
    if (Firebase.setInt(firebaseData, path + "/CMD", 200))
    {
        Serial.println("PASSED");
        Serial.println("PATH: " + firebaseData.dataPath());
        Serial.println("TYPE: " + firebaseData.dataType());
    ...
    if (Firebase.setInt(firebaseData, path + "/AV", 300, wrong_ETag))
    {
        Serial.println("PASSED");
        Serial.println("PATH: " + firebaseData.dataPath());
        Serial.println("TYPE: " + firebaseData.dataType());
    ...
    if (Firebase.deleteNode(firebaseData, path + "/CMD", wrong_ETag))
    {

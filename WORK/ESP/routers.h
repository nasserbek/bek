...
IPAddress   BLYNK_PI4(192,168,10,114);
IPAddress   BLYNK_PI3(192,168,10,195);
//ch
...
//nice
const char* SSID_NICE                ="SFR_BEK-23C0";
...
NetworkConfig nets[] =
{
    {SSID_METEOR      , WIFI_PW_METEOR   , BLYNK_PI4    , BLYNK_PI3        , 8080, "FIELD"},
    {SSID_FLIP7       , WIFI_PW_FLIP7    , BLYNK_FLIP7  , BLYNK_FLIP7      , 8080, "MOBILE"},
    {SSID_CH          , WIFI_PW_CH       , BLYNK_CH_PC , BLYNK_CH_OMV_PVE , 8080, "CH"},
    {SSID_NICE        , WIFI_PW_SFR      , BLYNK_SFR    , BLYNK_SFR        , 8080, "NICE"} 
};

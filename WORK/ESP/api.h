...
void apiSend(esp32baord RemoteBoard, String virtualPin, int value) {
  String response;
  ...
  if (RemoteBoard == ESP1 && esp.BOARD != ESP1)
  {
    ...
    if (RemoteBoard == ESP2 && esp.BOARD != ESP2)
  {
   ...
   if (RemoteBoard == ESP3 && esp.BOARD != ESP3)
  {

...
void gpioMode()
{
  ...
  // Create mode value (0–3)
    ...
    if(startupMode == FLASH_THEN_OPEN) modeStr = "FLASH THEN OPEN ";
    else if (startupMode == OPEN_ONLY) modeStr = "OPEN_ONLY ";
    else if (startupMode == OPEN_LOCKLINK) modeStr = "OPEN_LOCKLINK ";
    Serial.println("");
...
/*********************************************** START OF LOCK LINK *****************************************************/
    case LL_pktWake:
                    ...
                    while(!woke)
                   {
                     ...
                     idx = 0;
                     delay(150);
                     ack =getLockAck(10 , 0x20 ,lockAckTimeout);
     ...
     break;
      ...
      case LL_pkt3642:
            ...
            ack =getLockAck(39 , 0x20 ,lockAckTimeout);
            //delay(50);
      ...
      DEBUG_PRINTLN("");
            ...
            delay(50);
            ack =getLockAck(1 , 0x06 ,lockAckTimeout);
            delay(200);
      ...
      DEBUG_PRINTLN("");
            ...
            delay(200);
            ack =getLockAck(8, 0xD7 ,lockAckTimeout);
            delay(200);
      ...
      DEBUG_PRINTLN("");
            ...
            delay(200);
            ack =getLockAck(8, 0xB2 ,lockAckTimeout);
            delay(200);
    ...
    if(ack) 
     {
      DEBUG_PRINTLN("CLOSING UPLOAD SESSION SUCCES");
        ...
        if( startupMode == FLASH_THEN_OPEN) state = CMD_OPEN_38400;

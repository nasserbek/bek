...
#define BLYNK_TEMPLATE_NAME         "CSR"
    ...
    #define AWS_IOT_PUBLISH_TOPIC_2   "csr2/pub"
    #define AWS_IOT_PUBLISH_TOPIC_3   "csr3/pub"
    
#ifdef CSR      //TTGO R64 SCATOLA 1CH TTGO
    #define VERSION_ID " CSR.36 "

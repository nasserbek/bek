...
#ifdef SDP
    #define gitHubURL  "https://raw.githubusercontent.com/nasserbek/bek/master/SDP/SPD.ino.ttgo-t1.bin"  // URL to download the firmware from

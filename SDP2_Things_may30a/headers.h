...
#define VERSION_ID " THINGS.28-05 " 
...
#else
  #ifdef THINGS
      #define gitHubURL  "https://raw.githubusercontent.com/nasserbek/bek/master/SDP2_Things_may30a/SDP2_Things_may30a.ino.ttgo-t1.bin" // URL to download the firmware from
  #else
